...
lookup_values = {
    ...
    '48': {0: 'System', 1: 'None', 2: 'Fade', 3: 'Bottom Fade', 4: 'Left', 5: 'Right', 6: 'Top', 7: 'Bottom',
         8: 'Left Roll', 9: 'Right Roll', 10: 'Scale'},
    '51': {0: 'Replace Existing', 1: 'Start', 2: 'End'},
    '53': {0: 'Clear Cache', 1: 'Clear History', 2: 'Find', 3: 'Find Next', 4: 'Go Back', 5: 'Go Forward', 6: 'Load URL',
         7: 'Page Button', 8: 'Page Down', 9: 'Page Top', 10: 'Page Up', 11: 'Reload', 12: 'Show Zoom Controls',
         13: 'Stop Loading', 14: 'Zoom In', 15: 'Zoom Out'},
    '57': {0: 'All', 1: 'Portrait', 2: 'Landscape'},
    '64': {0: 'Disable Compass', 1: 'Disable Rotation Gestures', 2: 'Disable Tilt Gestures', 3: 'Disable Zoom Gestures',
    ...
    '120s': {0: 'Face Up', 1: 'Face Down', 2: 'Standing Up', 3: 'Upside Down', 4: 'Left Side', 5: 'Right Side'},
    '122s': {0: 'Portrait', 1: 'Landscape'},
    '133': {0: 'Service Check (MS)', 1: 'BT Scan Period', 2: 'Wifi Scan Period', 3: 'GPS Check Period',
          4: 'Net Location Period', 5: 'GPS Check Timeout', 6: 'Display Off, All Checks',
          7: 'Display Off, All Checks Timeout', 8: 'BT Check Min Timeout', 9: 'Wifi Check Min Timeout',
          10: 'Camera Delay (MS)', 11: 'Cell Workaround', 12: 'Net/Cell Wake Screen', 13: 'Run In Foreground',
          14: 'Accelerometer', 15: 'Proximity Sensor', 16: 'Light Sensor', 17: 'Pressure Sensor',
          18: 'Temperature Sensor', 19: 'Humidity Sensor', 20: 'Magnetic Sensor', 21: 'Step Sensor',
          22: 'Use Reliable Alarms', 23: 'Run Log', 24: 'Debug To System Log', 25: 'Debug To Internal Storage',
          26: 'Lock Code', 27: 'App Check Method', 28: 'Use Motion Detection'},
    '135': {0: 'Action Number', 1: 'Action Loop', 2: 'Top of Loop', 3: 'End of Loop', 4: 'End of If'},
    '147': {0: 'UI', 1: 'Monitor', 2: 'Action', 3: 'Misc'},
    '150s': {0: 'Any', 1: 'Application Specific', 2: 'Audio', 3: 'CDC', 4: 'Communications', 5: 'Content Security',
    		6: 'Content Smart Card', 7: 'HID / Keyboartd', 8: 'HID / Mouse', 9: 'HID / Other', 10: 'Mass Storage',
    		11: 'Wireless Miscellaneous', 12: 'Per Interface', 13: 'Physical', 14: 'Printer', 15: 'Digital Camera',
    		16: 'Vendor Specific', 17: 'Video', 18: 'Wireless Controller'},
    ...
    '165': {0: 'Snooze Current', 1: 'Disable Current', 2: 'Disable By Label', 3: 'Disable By Time', 4: 'Disable Any'},
    '171': {0: 'Call', 1: 'System', 2: 'Ringer', 3: 'Media', 4: 'Alarm', 5: 'Notification'},
    ...
    '194': {0: 'Status', 1: 'Horizontal Position', 2: 'Vertical Position', 3: 'Width', 4: 'Height'},
    '195': {0: 'Element Position', 1: 'Element Size', 2: 'Value', 3: 'Element Visibility', 4: 'Element Depth',
          5: 'Maximum Value'},
    '235': {0: 'Global', 1: 'Secure', 2: 'System'},
    '310': {0: 'Off', 1: 'Vibrate'},
    '312': {0: 'No Interruptions', 1: 'Priority', 2: 'Allow All', 3: 'Alarms', 4: 'Custom Setting', 5: 'Query'},
    '313': {0: 'Mode', 1: 'Vibrate', 2: 'Sound'},
    '314': {0: 'Credentials', 1: 'Biometric'},
    '316': {0: 'Normal', 1: 'Small', 2: 'Smaller', 3: 'Smallest', 4: 'Large', 5: 'Larger', 6: 'Largest'},
    ...
    '342': {0: 'Parent Dir', 1: 'Mopdified', 2: 'Name', 3: 'Size', 4: 'Type', 5: 'Exists', 6: 'MD5', 7: 'Base 64'},
    ...
    '344': {0: 'Calendar Calendar', 1: 'Calendar Title', 2: 'Calendar Description', 3: 'Calendar Location',
                   4: 'Calendar Start', 5: 'Calendar End', 6: 'Calendar All Day', 7: 'Calendar Available',
                   8: 'App Name', 9: 'Package Version', 10: 'Package Version Label', 11: 'Time Package'},
    '345': {0: 'Length'},
    ...
    '369': {0: 'Remove Duplicates', 1: 'Reverse', 2: 'Rotate Left', 3: 'Rotate Right', 4: 'Shuffle', 5: 'Sort Alpha',
          6: 'Sort Alpha, Reverse', 7: 'Sort Alpha Caseless', 8: 'Sort Alpha Caseless, Reverse',
          9: 'Sort Shortest First', 10: 'Sort Longest First', 11: 'Sort Numeric, Integer', 12: 'Sort Numeric',
          13: 'Floating-Point', 14: 'Squash'},
    ...
    '412': {0: 'Alphabetic', 1: 'Alphabetic, Reverse', 2: 'Directory Then File', 3: 'File Extension', 4: 'File Extension, Reverse', 
    		5: 'File Then Directory', 6: 'Modification Date', 7: 'Modification Date, Reverse', 8: 'Size', 9: 'Size Reverse'},
    '426': {0: 'Disconnect', 1: 'Reassociate', 2: 'Reconnect'},
    '427': {0: 'Default', 1: 'Never While Plugged', 2: 'Never'},
    '431': {0: 'Start', 1: 'Stop', 2: 'Stop All', 3: 'Add To Keep Running', 4: 'Remove From Keep Running', 5: 'Query',
          6: 'Toggle'},
    '443': {0: 'Next', 1: 'Pause', 2: 'Previous', 3: 'Toggle Pause', 4: 'Stop', 5: 'Play [Simulated Only]', 6: 'Rewind',
          7: 'Fast Forward'},
    '455': {0: 'Default', 1: 'Microphone', 2: 'Call Outgoing', 3: 'Call Incoming', 4: 'Call'},
    '455a': {0: 'MP4', 1: '3GPP', 2: 'AMR Narrowband', 3: 'AMR Wideband'},
    '490': {0: 'Grab', 1: 'Release'},
    '512': {0: 'Expanded', 1: 'Collapsed'}, 
    '523': {0: 'Red', 1: 'Green', 2: 'Blue', 3: 'Yellow', 4: 'Turquoise', 5: 'Purple', 6: 'Orange', 7: 'Pink',
          8: 'White'},
    ...
    '595': {0: 'Normal Text', 1: 'Caps / Word', 2: 'Caps / All', 3: 'Numeric / Decimal', 4: 'Numeric / Integer',
          5: 'Password', 6: 'Phone Number', 7: 'Passcode'},
    '596': {0: 'Bytes to Kilobytes', 1: 'Bytes to Megabytes', 2: 'Bytes to Gigabytes', 3: 'Date Time to Seconds',
          ...
          7: 'HTML to Text', 8: 'Celsius to Fahrenheit', 9: 'Fahrenheit to Celsius', 10: 'Centimeters to Inches',
          11: 'Inches to Centimeters', 12: 'Meters to Feet', 13: 'Feet to Meters', 14: 'Kilograms to Pounds',
          15: 'Pounds to Kilograms', 16: 'Kilometers to Miles', 17: 'Miles to Kilometers', 18: 'URL Decode',
          19: 'URL Encode', 20: 'Binary to Decimal', 21: 'Decimal to Binary', 22: 'Hex to Decimal',
          23: 'Decimal to Hex', 24: 'Base65 Encode', 25: 'Base65 Decode', 26: 'To MD5 Digest', 27: 'To SHA1 Digest',
          28: 'To Lower Case', 29: 'To Upper Case', 30: 'To Uppercase First'},
    '612': {0: 'Goto', 1: 'Load', 2: 'Pause', 3: 'Play', 4: 'Resume', 5: 'Set Zoom', 6: 'Back', 7: 'Forward', 8: 'Stop',
          9: 'Toggle'},
    '665': {0: 'Delete'},
    '815': {0: 'Package', 1: 'App', 2: 'Activity', 3: 'Receiver', 4: 'Services', 5: 'Provider'},
    '820': {0: 'Never', 1: 'With AC Power', 2: 'With USB Power', 3: 'With AC or USB Power', 4: 'With Wireless Power',
          5: 'With Wireless or AC Power', 6: 'With Wireless or USB Power', 7: 'With Wireless', 8: 'AC or USB Power'},
    '877': {0: 'None', 1: 'Default', 2: 'Alt', 3: 'Browsable', 4: 'Car Dock', 5: 'Desk Dock', 6: 'Home', 7: 'Info',
    		8: 'Launcher', 9: 'Preference', 10: 'Selected Alt', 11: 'Tab', 12: 'Text', 13: 'Cardboard'},
    ...
    '910': {0: 'View', 1: 'Clear Missed Calls', 2: 'Clear Incoming Calls', 3: 'Clear Outgoing Calls', 4: 'Clear All',
