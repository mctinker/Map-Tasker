from collections import namedtuple
    ...
    "101t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Naming Sequence", arg_type="0", arg_eval="Naming Sequence"),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Insert In Gallery", arg_type="3", arg_eval="Insert In Gallery"),
            ...
            ArgumentCode(arg_id="7", arg_required=True, arg_name="White Balance", arg_type="0", arg_eval="White Balance"),
    ...
    "104t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Package/App Name", arg_type="2", arg_eval="Package/App Name="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="'Open With' Dialog", arg_type="3", arg_eval=["e", ", 'Open With' Dialog"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="'Open With' Title", arg_type="1", arg_eval=", 'Open With' Title="),
        ],
        name="Browse URL",
        category="80",
        canfail="True",
    ...
    "105t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Is Sensitive Data", arg_type="3", arg_eval="Is Sensitive Data"),
        ],
        name="Set Clipboard",
        category="104",
        canfail="True",
    ...
    "111t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=False, arg_name="Recipient(s)", arg_type="1", arg_eval="Recipient(s)"),
    ...
    "112t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Pass Variables", arg_type="1", arg_eval="Pass Variables"),
        ],
    ...
    "113t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Keep Wi-Fi when turning on", arg_type="3", arg_eval="Keep Wi-Fi when turning on"),
        ],
    ...
    "116t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Content Type", arg_type="1", arg_eval="Content Type"),
            ArgumentCode(arg_id="7", arg_required=False, arg_name="Output File", arg_type="1", arg_eval="Output File"),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Trust Any Certificate", arg_type="3", arg_eval="Trust Any Certificate"),
        ],
        name="HTTP Post",
        category="80",
        canfail="True",
    ...
    "117t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=False, arg_name="User Agent", arg_type="1", arg_eval="User Agent"),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Timeout", arg_type="0", arg_eval="Timeout"),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Trust Any Certificate", arg_type="3", arg_eval="Trust Any Certificate"),
        ],
        name="HTTP Head",
        category="80",
        canfail="True",
    ...
    "123t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Use Root", arg_type="3", arg_eval=["e", ", Use Root"]),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Store Output In", arg_type="1", arg_eval=", Store Output In="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Store Errors In", arg_type="1", arg_eval=", Store Errors In="),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Store Result In", arg_type="1", arg_eval=", Timeout="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Use Global Namespace", arg_type="3", arg_eval="Use Global Namespace"),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Use Tasker Settings", arg_type="3", arg_eval="Use Tasker Settings"),
    ...
    "126t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Local Variable Passthrough", arg_type="3", arg_eval=["e", ", Local Variable Passthrough"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Replace On Passthrough", arg_type="3", arg_eval=["e", ", Replace On Passthrough"]),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Limit Passthrough To", arg_type="1", arg_eval=", Limit Passthrough To="),
        ],
        name="Return",
        category="105",
        canfail="False",
    ...
    "129t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Auto Exit", arg_type="3", arg_eval=["e", ", Auto Exit"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout="),
        ],
        name="JavaScriptlet",
        category="35",
        canfail="True",
    ...
    "130t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Parameter 1 (%par1)", arg_type="1", arg_eval=", Parameter 1="),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Parameter 2 (%par2)", arg_type="1", arg_eval=", Parameter 2="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Return Value Variable", arg_type="1", arg_eval=", Return Value Variable="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Stop", arg_type="3", arg_eval=["e", ", Stop"]),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Local Variable Passthrough", arg_type="3", arg_eval=["e", ", Local Variable Passthrough"]),
            ArgumentCode(arg_id="7", arg_required=False, arg_name="Limit Passthrough To", arg_type="1", arg_eval=", Limit Passthrough To="),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Reset Return Variable", arg_type="3", arg_eval=["e", ", Reset Return Variable"]),
            ArgumentCode(arg_id="9", arg_required=True, arg_name="Allow Overwrite Variables", arg_type="3", arg_eval=["e", ", Allow Overwrite Variables"]),
            ArgumentCode(arg_id="10", arg_required=True, arg_name="Structure Output (JSON, etc)", arg_type="3", arg_eval=["e", ", Structure Output (JSON, etc)"]),
        ],
        name="Perform Task",
        category="105",
        canfail="True",
    ...
    "131t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Libraries", arg_type="1", arg_eval=", Libraries="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Auto Exit", arg_type="3", arg_eval=["e", ", Auto Exit"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval="Timeout (Seconds)"),
        ],
        name="JavaScript",
        category="35",
        canfail="True",
    ...
    "136t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Set", arg_type="3", arg_eval=["Set=", "l", "switch_set"]),
        ],
        name="Sound Effects",
        category="20",
        canfail="False",
    ...
    "147t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Section", arg_type="0", arg_eval=["Section=", "l", "147"]),
        ],
        name="Show Prefs",
        category="110",
        canfail="False",
    ...
    "153t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Source", arg_type="0", arg_eval=["Source=", "l", "153a"]),
    ...
    "156t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Format", arg_type="0", arg_eval=["Format=", "l", "156"]),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Locality", arg_type="0", arg_eval=["Locality=", "l", "156a"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Beat Timing", arg_type="0", arg_eval=", Best Timing="),
    ...
    "157t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Icon", arg_type="4", arg_eval="Icon"),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Collapse Panel On Click", arg_type="3", arg_eval="Collapse Panel On Click"),
        ],
    ...
    "159t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Name", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Set", arg_type="0", arg_eval=["Set=", "l", "switch_set"]),
        ],
        name="Profile Status",
        category="110",
        canfail="True",
    ...
    "15t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Allow Cancel", arg_type="3", arg_eval=["e", "Allow Cancel"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Remember Till Off", arg_type="3", arg_eval=["e", "Remember Till Off"]),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Full Screen", arg_type="3", arg_eval=["e", "Full Screen"]),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Background Image", arg_type="1", arg_eval=", Background Image="),
    ...
    "162t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Number", arg_type="0", arg_eval=["Number=", "l", "162"]),
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Task", arg_type="1", arg_eval=", Task="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Status", arg_type="0", arg_eval=[", Status=", "l", "162a"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Can Use On Locked Device", arg_type="3", arg_eval=["e", ", Can Use On Locked Device"]),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Long Click Task", arg_type="1", arg_eval=", Long Click Task="),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Double Click Task", arg_type="1", arg_eval=", Double Click Task="),
            ...
            ArgumentCode(arg_id="10", arg_required=False, arg_name="Long Click Command", arg_type="1", arg_eval=", Long Click Command="),
            ArgumentCode(arg_id="11", arg_required=False, arg_name="Double Click Command", arg_type="1", arg_eval=", Double Click Command="),
            ArgumentCode(arg_id="12", arg_required=False, arg_name="Command Prefix", arg_type="1", arg_eval=", Command Prefix="),
    ...
    "171t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Stream", arg_type="0", arg_eval=["Stream=", "l", "171"]),
    ...
    "172t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Stream", arg_type="0", arg_eval=[", Stream=", "l", "171"]),
        ],
        name="Morse",
        category="10",
        canfail="False",
    ...
    "176t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="File", arg_type="1", arg_eval="File="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Insert In Gallery", arg_type="3", arg_eval=["e", ", Insert In Gallery"]),
        ],
    ...
    "187t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="File", arg_type="1", arg_eval="File="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Image Quality", arg_type="0", arg_eval=", Image Quality="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Delete From Memory After", arg_type="3", arg_eval=["e", ", Delete From Memory After"]),
        ],
        name="Save Image",
        category="52",
        canfail="True",
    ...
    "188t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Max Width Or Height", arg_type="0", arg_eval=", Max Width or Height="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Respect EXIF Orientation", arg_type="3", arg_eval=["e", ", Respect EXIF Orientation"]),
        ],
        name="Load Image",
        category="52",
        canfail="True",
    ...
    "189t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="From Left (%)", arg_type="0", arg_eval="From Left (%)="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="From Right (%)", arg_type="0", arg_eval=", From Right (%)="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="From Top (%)", arg_type="0", arg_eval=", From Top (%)="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="From Bottom (%)", arg_type="0", arg_eval=", From Bottom (%)="),
        ],
        name="Crop Image",
        category="52",
        canfail="True",
    ...
    "190t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Direction", arg_type="0", arg_eval=["Direction=", "l", "190"]),
        ],
        name="Flip Image",
        category="52",
        canfail="True",
    ...
    "191t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Direction", arg_type="0", arg_eval=["Direction=", "l", "191"]),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Degrees", arg_type="0", arg_eval=[", Degrees=", "l", "191a"]),
        ],
        name="Rotate Image",
        category="52",
        canfail="True",
    ...
    "192t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Type", arg_type="0", arg_eval=["Direction=", "l", "192"]),
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Sound", arg_type="1", arg_eval=", Sound="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Stream", arg_type="0", arg_eval=[", Stream=", "l", "171"]),
        ],
        name="Play Ringtone",
        category="65",
        canfail="False",
    ...
    "194t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Name", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Test", arg_type="0", arg_eval=[", Test=", "l", "194"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Store Result In", arg_type="1", arg_eval=", Store Result In="),
        ],
        name="Test Scene",
        category="102",
        canfail="True",
    ...
    "195t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Test", arg_type="0", arg_eval=[", Test=", "l", "195"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Store Result In", arg_type="1", arg_eval=", Store Result In="),
        ],
        name="Test Element",
        category="102",
        canfail="True",
    ...
    "2089e": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="6", arg_required=True, arg_name="", arg_type="0", arg_eval=["", "e", ", Only On Wifi"]),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="", arg_type="0", arg_eval=", Network Name/MAC Address="),
        ],
        name="HTTP Request",
        category="",
        canfail="",
    ...
    "2097e": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="1", arg_required=True, arg_name="", arg_type="5", arg_eval=["", "e", "Ignore Set By Tasker"]),
        ],
    ...
    "20t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Package/App Name", arg_type="2", arg_eval=["a", "", "App="]),
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Data", arg_type="1", arg_eval=", Data="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Exclude From Recent Apps", arg_type="3", arg_eval=["e", "Exclude From Recent Apps"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Always Start New Copy", arg_type="3", arg_eval=["e", "Always Start New Copy"]),
        ],
        name="Launch App",
        category="15",
        canfail="True",
    ...
    "235t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Read Setting To", arg_type="1", arg_eval=", Read Setting To="),
        ],
        name="Custom Setting",
        category="30",
        canfail="True",
    ...
    "2s": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="", arg_type="0", arg_eval=["Status=", "l", "switch_set"]),
        ],
        name="BT Status",
        category="",
        canfail="",
    ...
    "3001e": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="", arg_type="0", arg_eval=["Sensitivity=", "l", "3001ea"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="", arg_type="0", arg_eval=["Duration=", "l", "3001eb"]),
        ],
        name="Shake",
        category="",
        canfail="",
    ...
    "3050e": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="", arg_type="0", arg_eval=["", "e", ", User Variables Only"]),
        ],
        name="Variable Set",
        category="",
        canfail="",
    ...
    "312t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Allow Callers", arg_type="0", arg_eval="Allow Callers"),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Allow Repeat Callers", arg_type="3", arg_eval="Allow Repeat Callers"),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Allow SMS Senders", arg_type="0", arg_eval="Allow SMS Senders"),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Allow Categories", arg_type="1", arg_eval="Allow Categories"),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Suppressed Effects", arg_type="1", arg_eval="Suppressed Effects"),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
        ],
        name="Interrupt Mode",
        category="20",
        canfail="True",
    ...
    "313t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Ignore DND", arg_type="3", arg_eval=["e", ", Ignore DND"]),
        ],
        name="Sound Mode",
        category="20",
        canfail="False",
    ...
    "314t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Description", arg_type="1", arg_eval=", Description="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Cancel Button Text", arg_type="1", arg_eval=", Cancel Button Text="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Number Of Attempts", arg_type="0", arg_eval=", Number of Attempts="),
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Read Result To", arg_type="1", arg_eval=", Read Result Into="),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout (Seconds)="),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Confirmation Required", arg_type="3", arg_eval=["e", ", Confirmation Required"]),
            ArgumentCode(arg_id="9", arg_required=True, arg_name="Device Credentials Allowed", arg_type="3", arg_eval=["e", ", Device Credentials Allowed"]),
        ],
    ...
    "317t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Set", arg_type="3", arg_eval=["Set=", "l", "switch_set"]),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
        ],
        name="NFC",
        category="80",
        canfail="True",
    ...
    "318t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Alternative Method (Check Help)", arg_type="3", arg_eval=["e", ", Alternative Method (Check Help)"]),
        ],
        name="Force Rotation",
        category="40",
        canfail="True",
    ...
    "319t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Required Permissions", arg_type="1", arg_eval="Required Permissions="),
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Prompt If Not Granted", arg_type="1", arg_eval=", Prompt If Not Granted="),
        ],
    ...
    "320t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Number", arg_type="0", arg_eval=", Number="),
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Average Result Variable", arg_type="1", arg_eval=", Average Result Variable="),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Min Result Variable", arg_type="1", arg_eval=", Min Result Variable="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Max Result Variable", arg_type="1", arg_eval=", Max Result Variable="),
        ],
        name="Ping",
        category="80",
        canfail="True",
    ...
    "321t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Google Drive Account", arg_type="1", arg_eval="Google Drive/Account="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Data / File", arg_type="1", arg_eval=", Data/File="),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Remote File Name", arg_type="1", arg_eval=", Remote File Name="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Remote Folder", arg_type="1", arg_eval=", Remote Folder="),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Content Description", arg_type="1", arg_eval=", Content Description="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Overwrite If Exists", arg_type="3", arg_eval=["e", ", Overwrite If Exists"]),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Publicly Share File", arg_type="3", arg_eval=["e", ", Publicly Share File"]),
    ...
    "322t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Path", arg_type="1", arg_eval="Path="),
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Google Drive Account", arg_type="1", arg_eval=", Google Drive Account="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Include User Vars/Prefs", arg_type="3", arg_eval=["e", ", Include User Vars/Prefs"]),
        ],
        name="Data Backup",
        category="110",
        canfail="True",
    ...
    "323t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Bluetooth", arg_type="3", arg_eval=["e", "Bluetooth"]),
    ...
    "324t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Google Drive Account", arg_type="1", arg_eval="Google Drive Account="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Type", arg_type="0", arg_eval=[", Type=", "l", "324"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Files or Folders", arg_type="0", arg_eval=[", Files or Folders=", "l", "324a"]),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Remote Folder", arg_type="1", arg_eval="Remote Folder"),
    ...
    "325t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Google Drive Account", arg_type="1", arg_eval="Google Drive Account="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Trash Value", arg_type="0", arg_eval=[", Trash Value=", "l", "325"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Type", arg_type="0", arg_eval=[", Type=", "l", "325a"]),
            ...
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Remote File Name", arg_type="1", arg_eval=", Remote File Name="),
    ...
    "326t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Google Drive Account", arg_type="1", arg_eval="Google Drive Account="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Type", arg_type="0", arg_eval=[", Type=", "l", "325a"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="File Id", arg_type="1", arg_eval=", File ID="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Remote Folder", arg_type="1", arg_eval=", Remote Folder="),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Remote File Name", arg_type="1", arg_eval=", Remote File Name="),
    ...
    "327t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Google Drive Account", arg_type="1", arg_eval="Google Drive Account="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Full Access", arg_type="3", arg_eval=["e", ", Full Access"]),
        ],
        name="GD Sign In",
        category="51",
        canfail="True",
    ...
    "328t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Time Between Inputs", arg_type="0", arg_eval=", Time Between Inputs="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Don't Restore Keyboard", arg_type="3", arg_eval=["e", ", Don't Restore Keyboard"]),
        ],
        name="Keyboard",
        category="55",
        canfail="True",
    ...
    "330t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Payload To Write", arg_type="1", arg_eval="Payload To Write="),
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Payload Type", arg_type="1", arg_eval=", Payload Type="),
        ],
        name="NFC Tag",
        category="80",
        canfail="True",
    ...
    "334t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Stream", arg_type="0", arg_eval=[", Type=", "l", "171"]),
            ...
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Continue Task Immediately", arg_type="3", arg_eval=["e", ", Continue Task Immediately"]),
            ArgumentCode(arg_id="6", arg_required=False, arg_name="File", arg_type="1", arg_eval=", File="),
            ArgumentCode(arg_id="7", arg_required=False, arg_name="Override API Key", arg_type="1", arg_eval=", Override API Key="),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Respect Audio Focus", arg_type="3", arg_eval="Respect Audio Focus"),
        ],
        name="Say WaveNet",
        category="10",
        canfail="True",
    ...
    "335t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Package/App Name", arg_type="1", arg_eval="Package/App Name="),
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Ignore Packages", arg_type="1", arg_eval=", Ignore Packages="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Ignore Unlaunchable Apps", arg_type="3", arg_eval=["e", ", Ignore Unlaunchable Apps"]),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Get All Details", arg_type="3", arg_eval=["e", ", Get All Details"]),
        ],
        name="App Info",
        category="15",
        canfail="True",
    ...
    "339t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Method", arg_type="0", arg_eval=["Method=", "l", "339"]),
            ...
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Query Parameters", arg_type="1", arg_eval=", Query Parameters="),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Body", arg_type="1", arg_eval=", Body="),
            ArgumentCode(arg_id="6", arg_required=False, arg_name="File To Send", arg_type="1", arg_eval=", File To Send="),
            ArgumentCode(arg_id="7", arg_required=False, arg_name="File/Directory To Save With Output", arg_type="1", arg_eval=", File/Directory To Save With Output="),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout="),
            ArgumentCode(arg_id="9", arg_required=True, arg_name="Trust Any Certificate", arg_type="3", arg_eval=["e", ", Trust Any Certificate"]),
            ArgumentCode(arg_id="10", arg_required=True, arg_name="Automatically Follow Redirects", arg_type="3", arg_eval=["e", ", Automatically Follow Redirects"]),
            ArgumentCode(arg_id="11", arg_required=True, arg_name="Use Cookies", arg_type="3", arg_eval=["e", ", Use Cookies"]),
            ArgumentCode(arg_id="12", arg_required=True, arg_name="Structure Output (JSON, etc)", arg_type="3", arg_eval=["e", ", Structure Output (JSON, etc)"]),
        ],
        name="HTTP Request",
        category="80",
        canfail="True",
    ...
    "340t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Action", arg_type="0", arg_eval=["Action=", "l", "340"]),
    ...
    "342t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Store Result In", arg_type="1", arg_eval=", Store Result In="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Use Root", arg_type="3", arg_eval=["e", ", Use Root"]),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Use Global Namespace", arg_type="3", arg_eval="Use Global Namespace"),
        ],
        name="Test File",
        category="50",
        canfail="True",
    ...
    "345t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Data", arg_type="1", arg_eval=", Data="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Store Result In", arg_type="1", arg_eval=", Store Results In="),
        ],
        name="Test Variable",
        category="120",
        canfail="True",
    ...
    "351t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Method", arg_type="0", arg_eval=["Method=", "l", "351"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Client ID", arg_type="1", arg_eval=", Client ID="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Client Secret", arg_type="1", arg_eval=", Client Secret="),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Endpoint To Get Code", arg_type="1", arg_eval=", Endpoint To Get Code="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Endpoint To Get Refresh Token", arg_type="1", arg_eval=", Endpoint To Get Refresh Token="),
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Scopes", arg_type="1", arg_eval=", Scopes="),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Force Re-Authentication", arg_type="3", arg_eval=["e", "Force Re-Authentication"]),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout="),
    ...
    "352t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Network Type", arg_type="0", arg_eval=["Network Type=", "l", "352"]),
    ...
    "354t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Variable Array", arg_type="1", arg_eval="Variable Array="),
    ...
    "355t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Fill Spaces", arg_type="3", arg_eval=["e", ", Fill Spaces"]),
        ],
        name="Array Push",
        category="120",
        canfail="False",
    ...
    "360t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Default Input", arg_type="1", arg_eval=", Default Input="),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Close After (Seconds)", arg_type="0", arg_eval=", Close After (Seconds)="),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Input Type", arg_type="1", arg_eval=", Input Type="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Use HTML", arg_type="3", arg_eval=["e", ", Use HTML"]),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Pre-Select Input", arg_type="3", arg_eval=["e", ", Pre-Select Input"]),
            ArgumentCode(arg_id="8", arg_required=False, arg_name="Output Variable Name", arg_type="1", arg_eval="Output Variable Name"),
        ],
        name="Input Dialog",
        category="55",
        canfail="True",
    ...
    "363t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Type", arg_type="0", arg_eval=["Set=", "l", "switch_set"]),
    ...
    "364t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Minutes Difference", arg_type="0", arg_eval="Minutes Difference="),
        ],
    ...
    "366t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval="Timeout (Seconds)="),
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Minimum Accuracy (meters)", arg_type="1", arg_eval=", Minimum Accuracy (meters)="),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Speed (meters/second)", arg_type="1", arg_eval=", Speed (meters/second)="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Altitude (meters)", arg_type="1", arg_eval=", Altitude (meters)="),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Near Location", arg_type="1", arg_eval=", Near Location="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Enable Location If Needed", arg_type="3", arg_eval=["e", ", Enable Location If Needed"]),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Last Location If Timeout", arg_type="3", arg_eval=["e", ", Last Location If Timeout"]),
            ArgumentCode(arg_id="8", arg_required=False, arg_name="Min Speed Accuracy (m/s)", arg_type="1", arg_eval=", Min Speed Accuracy (m/s)="),
            ArgumentCode(arg_id="9", arg_required=True, arg_name="Force High Accuracy", arg_type="3", arg_eval=["e", ", Force High Accuracy"]),
        ],
    ...
    "368t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Select Radius", arg_type="3", arg_eval=["e", ", Select Radius"]),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Initial Location", arg_type="1", arg_eval=", Initial Location="),
    ...
    "369t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Variable Array", arg_type="1", arg_eval="Variable Array="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Type", arg_type="0", arg_eval=[", Type=", "l", "369"]),
        ],
        name="Array Process",
        category="120",
        canfail="False",
    ...
    "370t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Shortcut="),
    ...
    "373t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Type", arg_type="1", arg_eval="Type="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout (Seconds)="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Convert Orientation", arg_type="3", arg_eval=["e", ", Convert Orientation"]),
        ],
        name="Test Sensor",
        category="104",
        canfail="True",
    ...
    "374t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Output File", arg_type="1", arg_eval=", Output File="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Sound", arg_type="3", arg_eval=["e", ", Sound"]),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Video Encoder", arg_type="1", arg_eval=", Video Encoder="),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Resolution", arg_type="1", arg_eval=", Resolution="),
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Video Bitrate", arg_type="1", arg_eval=", Video Bitrate="),
            ArgumentCode(arg_id="7", arg_required=False, arg_name="Video Framerate", arg_type="1", arg_eval="Video Framerate"),
        ],
        name="Screen Capture",
        category="40",
        canfail="True",
    ...
    "375t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval="Timeout (Seconds)"),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Enable Debugging (Check Help)", arg_type="3", arg_eval="Enable Debugging (Check Help)"),
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Result Encoding", arg_type="1", arg_eval="Result Encoding"),
        ],
        name="ADB Wifi",
        category="35",
        canfail="True",
    ...
    "376t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="File", arg_type="1", arg_eval="File="),
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Mime Type", arg_type="1", arg_eval=", Mime Type="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Show Chooser Dialog", arg_type="3", arg_eval=["e", ", Show Chooser Dialog"]),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Chooser Dialog Title", arg_type="1", arg_eval=", Chooser Dialog Title="),
        ],
        name="Share File",
        category="50",
        canfail="True",
    ...
    "377t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Close After (Seconds)", arg_type="0", arg_eval=", Close After (Seconds)="),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Use HTML", arg_type="3", arg_eval=["e", ", Use HTML"]),
            ArgumentCode(arg_id="8", arg_required=False, arg_name="Image", arg_type="1", arg_eval=", Image="),
            ArgumentCode(arg_id="9", arg_required=False, arg_name="Max Width Or Height", arg_type="1", arg_eval=", Max Width or Height="),
        ],
    ...
    "378t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Selected Items", arg_type="1", arg_eval=", Long Click Task="),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Long Click Task", arg_type="1", arg_eval="Long Click Task"),
            ...
            ArgumentCode(arg_id="9", arg_required=True, arg_name="Close After (Seconds)", arg_type="0", arg_eval=", Close After (Seconds)="),
            ArgumentCode(arg_id="10", arg_required=True, arg_name="Use HTML", arg_type="3", arg_eval=["e", ", Use HTML"]),
            ArgumentCode(arg_id="11", arg_required=True, arg_name="First Visible Index", arg_type="0", arg_eval=", First Visible Index="),
            ArgumentCode(arg_id="12", arg_required=True, arg_name="Hide Filter", arg_type="3", arg_eval=["e", ", Hide Filter"]),
    ...
    "379t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Action", arg_type="0", arg_eval=["Action=", "l", "379"]),
            ...
            ArgumentCode(arg_id="5", arg_required=False, arg_name="User Restrictions", arg_type="1", arg_eval=", Restrictions="),
    ...
    "380t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Status Code", arg_type="1", arg_eval=", Status Code="),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Headers", arg_type="1", arg_eval=", Headers="),
            ...
            ArgumentCode(arg_id="8", arg_required=True, arg_name="File Inline", arg_type="3", arg_eval=["e", ", File Inline"]),
    ...
    "383t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Type", arg_type="0", arg_eval=["Contact=", "l", "383"]),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Continue Task Immediately", arg_type="3", arg_eval="Continue Task Immediately"),
        ],
        name="Settings Panel",
        category="30",
        canfail="False",
    ...
    "384t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Action", arg_type="0", arg_eval=[", Action=", "l", "384"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Type", arg_type="0", arg_eval=[", Type=", "l", "384a"]),
            ...
            ArgumentCode(arg_id="11", arg_required=False, arg_name="Range Current", arg_type="1", arg_eval=", Range Current="),
            ArgumentCode(arg_id="12", arg_required=False, arg_name="Range Step", arg_type="1", arg_eval="Range Step="),
            ArgumentCode(arg_id="13", arg_required=False, arg_name="Range Format", arg_type="1", arg_eval=", Range Format="),
            ArgumentCode(arg_id="14", arg_required=True, arg_name="Can Use On Locked Device", arg_type="3", arg_eval=["e", ", Can Use On Locked Device"]),
        ],
    ...
    "386t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval=["ID=", "l", "386"]),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Disallow/Allow", arg_type="0", arg_eval=["e", ", Skip Call Log"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Reject", arg_type="3", arg_eval=["e", ", Skip Notification"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Silence", arg_type="3", arg_eval="Silence"),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Skip Call Log", arg_type="3", arg_eval="Skip Call Log"),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Skip Notification", arg_type="3", arg_eval="Skip Notification"),
        ],
        name="Call Screening",
        category="90",
        canfail="True",
    ...
    "389t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Variable Names Splitter", arg_type="1", arg_eval=", Variable Name Splitter="),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Values", arg_type="1", arg_eval=", Values="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Values Splitter", arg_type="1", arg_eval=", Values Splitter="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Do Maths", arg_type="3", arg_eval=["e", ", Do Maths"]),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Max Rounding Digits", arg_type="0", arg_eval=["e", ", Keep Existing"]),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Keep Existing", arg_type="3", arg_eval=["e", ", Structure Output (JSON, etc)"]),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Structure Output (JSON, etc)", arg_type="3", arg_eval="Structure Output (JSON, etc)"),
        ],
    ...
    "390t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Text", arg_type="1", arg_eval=", Text="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Default Input", arg_type="1", arg_eval=", Default Input="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Close After (Seconds)", arg_type="0", arg_eval=", Close After (Seconds)="),
        ],
    ...
    "391t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Action", arg_type="0", arg_eval=["Action=", "l", "391"]),
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Title", arg_type="1", arg_eval=", Title="),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Text", arg_type="1", arg_eval=", Text="),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Type", arg_type="0", arg_eval=[", Type=", "l", "391a"]),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Animation Images", arg_type="1", arg_eval=", Animation Images="),
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Animation Tint", arg_type="1", arg_eval=", Animation Tint="),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Frame Duration", arg_type="0", arg_eval=", Frame Duration="),
    ...
    "392t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Name", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Structure Type", arg_type="1", arg_eval=", Structure Type="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Prevent JSON Smart Search", arg_type="3", arg_eval="Prevent JSON Smart Search"),
        ],
    ...
    "393t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Names", arg_type="1", arg_eval="Names="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Merge Type", arg_type="0", arg_eval=[", Title=", "l", "393"]),
            ...
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Join Output", arg_type="1", arg_eval=", Join Output="),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Replace Variables In Arrays", arg_type="3", arg_eval=""),
        ],
        name="Arrays Merge",
        category="120",
        canfail="True",
    ...
    "394t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Input Type", arg_type="0", arg_eval=["Input Type=", "l", "394"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Input", arg_type="1", arg_eval=", Input="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Input Format", arg_type="1", arg_eval=", Input Format="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Input Separator", arg_type="1", arg_eval=", Input Separator="),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Output Format", arg_type="1", arg_eval=", Output Format="),
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Output Format Separator", arg_type="1", arg_eval="Output Format Separator"),
            ArgumentCode(arg_id="7", arg_required=False, arg_name="Formatted Variable Names", arg_type="1", arg_eval=", Formatted Value Names="),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Get All Details", arg_type="3", arg_eval=["e", ", Get All Details"]),
            ArgumentCode(arg_id="9", arg_required=True, arg_name="Do Maths", arg_type="3", arg_eval=["e", ", Do Maths"]),
            ArgumentCode(arg_id="10", arg_required=True, arg_name="Output Offset Type", arg_type="0", arg_eval=[", Output Offset Type=", "l", "394a"]),
            ArgumentCode(arg_id="11", arg_required=True, arg_name="Output Offset", arg_type="1", arg_eval=", Output Offset="),
    ...
    "396t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Regex", arg_type="1", arg_eval=", Match Pattern/Regex="),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Match Pattern", arg_type="1", arg_eval="Match Pattern"),
        ],
    ...
    "397t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Output Hashtags", arg_type="3", arg_eval=["e", "Output Hashtags"]),
        ],
    ...
    "399t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Input Minimum", arg_type="1", arg_eval=", Input Minimum="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Input Maximum", arg_type="1", arg_eval=", Input Maximum="),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Output Minimum", arg_type="1", arg_eval=", Output Minimum="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Output Maximum", arg_type="1", arg_eval=", Output Maximum="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Invert", arg_type="3", arg_eval="Invert"),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Restrict Range", arg_type="3", arg_eval=["e", ", Invert"]),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Max Rounding Digits", arg_type="0", arg_eval=["e", ", Restrict Range"]),
            ArgumentCode(arg_id="9", arg_required=False, arg_name="Output Variable Name", arg_type="1", arg_eval=", Max Rounding Digits="),
        ],
        name="Variable Map",
        category="120",
        canfail="True",
    ...
    "39t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Structure Output (JSON, etc)", arg_type="3", arg_eval=["e", ", Structure Output (JSON, etc)"]),
        ],
        name="For",
        category="105",
        canfail="False",
    ...
    "400t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Use Root", arg_type="3", arg_eval=["e", ", Use Root"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Use Global Namespace", arg_type="3", arg_eval="Use Global Namespace"),
        ],
        name="Move",
        category="50",
        canfail="True",
    ...
    "406t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="File", arg_type="1", arg_eval="File="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Shred Level", arg_type="0", arg_eval=["e", ", Use Root"]),
    ...
    "407t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Copy To Cache", arg_type="3", arg_eval=["e", ", Copy To Cache"]),
        ],
        name="Pick Photos",
        category="55",
        canfail="True",
    ...
    "409t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Directory", arg_type="1", arg_eval="Directory="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Create All", arg_type="3", arg_eval=["e", ", Create All"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Use Root", arg_type="3", arg_eval=["e", ", Use Root"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Use Global Namespace", arg_type="3", arg_eval="Use Global Namespace"),
        ],
    ...
    "410t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Add Newline", arg_type="3", arg_eval=["e", ", Add New Line"]),
        ],
        name="Write File",
        category="50",
        canfail="True",
    ...
    "412t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Include Hidden Files", arg_type="3", arg_eval=["e", ", Include Hidden Files"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Use Root", arg_type="3", arg_eval=["e", ", Use Root"]),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Sort Select", arg_type="0", arg_eval=[", Sort Selection=", "l", "412"]),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Variable Array", arg_type="1", arg_eval=", Variable Array="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Use Global Namespace", arg_type="3", arg_eval="Use Global Namespace"),
        ],
        name="List Files",
        category="50",
    ...
    "414t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Pixel Coordinates", arg_type="1", arg_eval=", Pixel Coordinates="),
        ],
    ...
    "415t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Structure Output (JSON, etc)", arg_type="3", arg_eval="Structure Output (JSON, etc)"),
        ],
        name="Read Line",
        category="50",
        canfail="True",
    ...
    "418t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Number Of Events", arg_type="1", arg_eval=", Start Time"),
    ...
    "41t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Store In Messaging App", arg_type="3", arg_eval="Store In Messaging App"),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="SIM Card", arg_type="1", arg_eval=", SIM Card="),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Wait For Result", arg_type="3", arg_eval=["e", ", Wait For Result"]),
        ],
        name="Send SMS",
        category="90",
        canfail="True",
    ...
    "420t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="File", arg_type="1", arg_eval="File="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Delete Orig", arg_type="3", arg_eval=["e", ", Delete Dialog"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Level", arg_type="0", arg_eval=", Level="),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Output File", arg_type="1", arg_eval=", Output File="),
        ],
        name="Zip",
        category="50",
        canfail="True",
    ...
    "422t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="File", arg_type="1", arg_eval="File="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Delete Zip", arg_type="3", arg_eval=["e", ", Delete Zip"]),
        ],
        name="UnZip",
        category="50",
        canfail="True",
    ...
    "426t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Action", arg_type="0", arg_eval=["Action=", "l", "426"]),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Force", arg_type="3", arg_eval=["e", ", Force"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Report Failure", arg_type="3", arg_eval=["e", ", Report Failure"]),
        ],
        name="WiFi Net",
        category="80",
        canfail="False",
    ...
    "427t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Policy", arg_type="0", arg_eval=["Policy=", "l", "427"]),
        ],
        name="WiFi Sleep",
        category="80",
        canfail="False",
    ...
    "430t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval=["e", ", Only Monitor"]),
    ...
    "431t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Action", arg_type="0", arg_eval=["Action=", "l", "431"]),
    ...
    "438t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Device IDs/Names", arg_type="1", arg_eval="Device IDs/Name="),
    ...
    "443t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Simulate Media Button", arg_type="3", arg_eval=["e", ", Simulate Media Button"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Package/App Name", arg_type="2", arg_eval=", Package/App Name="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Use Notification If Available", arg_type="3", arg_eval=["e", ", Use Notification If Available"]),
        ],
        name="Media Control",
        category="65",
        canfail="False",
    ...
    "444t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Strobe (Hertz)", arg_type="0", arg_eval="Strobe (Hertz)"),
        ],
        name="TeslaLED",
        category="130",
        canfail="False",
    ...
    "445t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Continue Task Immediately", arg_type="3", arg_eval=["e", ", Continue Task Immediately"]),
        ],
        name="Music Play",
        category="65",
        canfail="True",
    ...
    "446t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Name/Path Filter", arg_type="1", arg_eval=", Name/Path Filter="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Other Filters", arg_type="1", arg_eval=", Other Filters="),
    ...
    "447t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Audio Only", arg_type="3", arg_eval=["e", ", Audio Only"]),
            ...
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Maximum Tracks", arg_type="0", arg_eval=", Maximum Tracks="),
        ],
        name="Music Play Dir",
        category="65",
        canfail="True",
    ...
    "449t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Clear Dir", arg_type="3", arg_eval=["e", ", Clear Dir"]),
        ],
        name="Music Stop",
        category="65",
        canfail="True",
    ...
    "455t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="File", arg_type="1", arg_eval="File="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Source", arg_type="0", arg_eval=[", Source=", "l", "455"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="MaxSize", arg_type="0", arg_eval=", MaxSize="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Codec", arg_type="0", arg_eval=[", Format=", "l", "455a"]),
    ...
    "460t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Grayscale", arg_type="3", arg_eval=["e", ", 'Grayscale' On"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Dim Wallpaper", arg_type="3", arg_eval=["e", ", 'Wallpaper' On"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Disable Always On Display", arg_type="3", arg_eval=["e", ", 'Disable Always On Display' On"]),
        ],
    ...
    "461t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Background Colour", arg_type="1", arg_eval=", Background Color="),
            ...
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Text Styles", arg_type="1", arg_eval=", Text Styles="),
            ArgumentCode(arg_id="7", arg_required=False, arg_name="Images", arg_type="1", arg_eval=", Images="),
            ArgumentCode(arg_id="8", arg_required=False, arg_name="Image Tints", arg_type="1", arg_eval=", Image Tint="),
            ArgumentCode(arg_id="9", arg_required=False, arg_name="Image Sizes", arg_type="1", arg_eval=", Image Sizes="),
            ...
            ArgumentCode(arg_id="12", arg_required=False, arg_name="Command Prefix", arg_type="1", arg_eval=", Command Prefix="),
            ArgumentCode(arg_id="13", arg_required=False, arg_name="Custom Layout", arg_type="1", arg_eval=", Command Layout="),
            ArgumentCode(arg_id="14", arg_required=True, arg_name="Material You Colors", arg_type="3", arg_eval=["e", ", Material You Colors"]),
            ArgumentCode(arg_id="15", arg_required=True, arg_name="Number of Columns", arg_type="1", arg_eval=", Number of Columns="),
            ArgumentCode(arg_id="16", arg_required=True, arg_name="Ask To Add If Not Present", arg_type="3", arg_eval="Ask To Add If Not Present"),
            ArgumentCode(arg_id="17", arg_required=False, arg_name="Separator", arg_type="1", arg_eval=""),
            ArgumentCode(arg_id="18", arg_required=True, arg_name="Continue Task Immediately", arg_type="3", arg_eval=""),
        ],
        name="Widget v2",
        category="110",
        canfail="True",
    ...
    "463t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Title", arg_type="1", arg_eval=", Title"),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Description", arg_type="1", arg_eval=", Description"),
    ...
    "464t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="11", arg_required=False, arg_name="Availability", arg_type="1", arg_eval=", Availability"),
    ...
    "465t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Minutes Prior", arg_type="1", arg_eval=", Minutes Prior"),
    ...
    "467t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="7", arg_required=False, arg_name="Relationship", arg_type="1", arg_eval=", Relationship"),
    ...
    "473t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Custom Sun Elevation Angle", arg_type="1", arg_eval=""),
        ],
    ...
    "474t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Structure Output (JSON, etc)", arg_type="3", arg_eval=", Structure Output (JSON, etc)"),
        ],
        name="Java Code",
        category="35",
        canfail="True",
    ...
    "475t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="File", arg_type="1", arg_eval="File="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Delete Orig", arg_type="3", arg_eval=["e", ", Delete Orig"]),
        ],
        name="GZip",
        category="50",
        canfail="True",
    ...
    "478t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval=", Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Command Pattern", arg_type="1", arg_eval=", Command Pattern"),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout (Seconds)"),
        ],
    ...
    "479t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Display Mode", arg_type="1", arg_eval=", Display Mode"),
            ...
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Blocking Overlay", arg_type="3", arg_eval=", Blocking Overlay"),
            ArgumentCode(arg_id="9", arg_required=False, arg_name="Show Animation", arg_type="1", arg_eval=", Show Animation"),
            ArgumentCode(arg_id="10", arg_required=False, arg_name="Dismiss Animation", arg_type="1", arg_eval=", Dismiss Animation"),
            ArgumentCode(arg_id="11", arg_required=False, arg_name="Auto Dismiss (ms)", arg_type="1", arg_eval=", Auto Dismiss (ms)"),
            ArgumentCode(arg_id="12", arg_required=True, arg_name="Show Over Everything", arg_type="3", arg_eval=", Show Over Everything"),
            ArgumentCode(arg_id="13", arg_required=True, arg_name="Continue Task Immediately", arg_type="3", arg_eval=", Continue Task Immediately"),
            ArgumentCode(arg_id="14", arg_required=True, arg_name="Long-Click Root To Dismiss", arg_type="3", arg_eval=", Long-Click Root To Dismiss"),
            ArgumentCode(arg_id="15", arg_required=False, arg_name="Physical Display", arg_type="1", arg_eval=", Physical Display"),
    ...
    "47t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Name", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Display As", arg_type="0", arg_eval=[", Display As=", "l", "47"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Horizontal Position", arg_type="0", arg_eval="Horizontal Position"),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Vertical Position", arg_type="0", arg_eval="Vertical Position"),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Animation", arg_type="0", arg_eval="Animation"),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Show Exit Button", arg_type="3", arg_eval="Show Exit Button"),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Show Over Keyguard", arg_type="3", arg_eval=["e", ", Show Exit Button"]),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Continue Task Immediately", arg_type="3", arg_eval=["e", ", Continue Task Immediately"]),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Allow Outside Boundaries", arg_type="3", arg_eval=["e", ", Allow Outside Boundaries"]),
            ArgumentCode(arg_id="9", arg_required=True, arg_name="Blocking Overlay +", arg_type="3", arg_eval=["e", ", Blocking Overlay +"]),
    ...
    "481t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Local Variable Passthrough", arg_type="3", arg_eval=", Local Variable Passthrough"),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Limit Passthrough To", arg_type="1", arg_eval=", Limit Passthrough To"),
        ],
    ...
    "482t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Blocking Overlay", arg_type="3", arg_eval=", Blocking Overlay"),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Transition Duration (ms)", arg_type="0", arg_eval=", Transition Duration (ms)"),
            ArgumentCode(arg_id="7", arg_required=False, arg_name="Transition Easing", arg_type="1", arg_eval=", Transition Easing"),
        ],
    ...
    "484t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval=", Output Variables"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Screen ID", arg_type="1", arg_eval=", Screen ID"),
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Timeout (ms)", arg_type="1", arg_eval=", Timeout (ms)"),
        ],
    ...
    "485t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Property Type", arg_type="1", arg_eval=", Property Type"),
        ],
    ...
    "488t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Overwrite Source Variable", arg_type="3", arg_eval=", Overwrite Source Variable"),
        ],
        name="Format JSON",
        category="120",
        canfail="True",
    ...
    "48t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Name", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Animation", arg_type="0", arg_eval=["Animation=", "l", "48"]),
        ],
        name="Hide Scene",
        category="102",
        canfail="True",
    ...
    "490t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Action", arg_type="0", arg_eval=["File=", "l", "490"]),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Use New API", arg_type="3", arg_eval=["e", ", Use New API"]),
        ],
    ...
    "4s": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="", arg_type="1", arg_eval="Name"),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="", arg_type="1", arg_eval="Address"),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="", arg_type="0", arg_eval=["Major Device Class=", "l", "4"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="", arg_type="0", arg_eval=["e", ", Standard Devices"]),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="", arg_type="0", arg_eval=["e", ", Low Energy (LE) Devices"]),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="", arg_type="0", arg_eval=["e", ", Unpaired Devices"]),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="", arg_type="0", arg_eval=["e", ", Toggle Bluetooth"]),
        ],
        name="BT Near",
        category="",
        canfail="",
    ...
    "511t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Set", arg_type="3", arg_eval=[", File=", "l", "switch_set"]),
    ...
    "51t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Scene Name", arg_type="1", arg_eval="Scene Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Element", arg_type="1", arg_eval=", Element="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Position", arg_type="0", arg_eval=[", Position=", "l", "51"]),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Text", arg_type="1", arg_eval=", Text="),
    ...
    "523t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Permanent", arg_type="3", arg_eval=["e", ", Permanent"]),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Priority", arg_type="0", arg_eval=", Priority="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Repeat Alert", arg_type="3", arg_eval=["e", ", Repeat Alert"]),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="LED Colour", arg_type="0", arg_eval=[", LED Color=", "l", "523"]),
            ...
            ArgumentCode(arg_id="10", arg_required=False, arg_name="Vibration Pattern", arg_type="1", arg_eval=", Vibration Pattern="),
            ArgumentCode(arg_id="11", arg_required=False, arg_name="Category", arg_type="1", arg_eval=", Category="),
            ArgumentCode(arg_id="12", arg_required=False, arg_name="Intensity Pattern", arg_type="1", arg_eval=", Intensity Pattern="),
    ...
    "525t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Colour", arg_type="0", arg_eval=[", LED Color=", "l", "523"]),
            ...
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Repeat Alert", arg_type="3", arg_eval=["e", ", Repeat Alert"]),
        ],
        name="Notify LED",
        category="10",
        canfail="False",
    ...
    "544t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Name", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Type", arg_type="0", arg_eval=[", Type=", "l", "544"]),
        ],
    ...
    "547t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Name", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="To", arg_type="1", arg_eval=", To="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Recurse Variables", arg_type="3", arg_eval=["e", ", Recursive Variables"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Do Maths", arg_type="3", arg_eval=["e", ", Do Maths"]),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Append", arg_type="3", arg_eval=["e", ", Append"]),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Max Rounding Digits", arg_type="0", arg_eval=", Max Rounding Digits="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Structure Output (JSON, etc)", arg_type="3", arg_eval=["e", ", Structure Output (JSON, etc)"]),
        ],
        name="Variable Set",
        category="120",
        canfail="True",
    ...
    "548t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Tasker Layout", arg_type="3", arg_eval=["e", ", Tasker Layout"]),
            ...
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Background Colour", arg_type="1", arg_eval=", Background Color="),
            ...
            ArgumentCode(arg_id="9", arg_required=True, arg_name="Continue Task Immediately", arg_type="3", arg_eval=["e", ", Continue Task Immediately"]),
            ArgumentCode(arg_id="10", arg_required=False, arg_name="Text Colour", arg_type="1", arg_eval=", Text Color="),
            ArgumentCode(arg_id="11", arg_required=True, arg_name="Dismiss On Click", arg_type="3", arg_eval=["e", ", Dismiss On Click"]),
            ArgumentCode(arg_id="12", arg_required=True, arg_name="Show Over Everything", arg_type="3", arg_eval=["e", ", Show Over Everything"]),
            ArgumentCode(arg_id="13", arg_required=False, arg_name="Position", arg_type="1", arg_eval=", Position="),
            ArgumentCode(arg_id="14", arg_required=True, arg_name="Use HTML", arg_type="3", arg_eval=["e", ", Use HTML"]),
    ...
    "549t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Pattern Matching", arg_type="3", arg_eval=["e", ", Pattern Matching"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Local Variables Only", arg_type="3", arg_eval=["e", ", Clear All Variables"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Clear All Variables", arg_type="3", arg_eval="Clear All Variables"),
        ],
        name="Variable Clear",
        category="120",
        canfail="False",
    ...
    "550t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=False, arg_name="Title", arg_type="1", arg_eval="Title="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Text", arg_type="1", arg_eval=", Text="),
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Background Image", arg_type="1", arg_eval=", Background Image="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Layout", arg_type="1", arg_eval="Layout"),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Layout="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Show Over Keyguard", arg_type="3", arg_eval=", Timeout (Seconds)="),
        ],
        name="Popup",
        category="10",
        canfail="False",
    ...
    "551t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=False, arg_name="Title", arg_type="1", arg_eval="Title"),
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Background Image", arg_type="1", arg_eval="Background Image"),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Layout", arg_type="1", arg_eval="Layout"),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval="Timeout (Seconds)"),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Show Over Keyguard", arg_type="3", arg_eval="Show Over Keyguard"),
        ],
        name="Menu",
        category="10",
        canfail="False",
    ...
    "552t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=False, arg_name="Text", arg_type="1", arg_eval="Text="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Mode", arg_type="0", arg_eval=[", Mode=", "l", "552"]),
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Task", arg_type="1", arg_eval=", Task="),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Task", arg_type="1", arg_eval=", Task="),
            ...
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Layout", arg_type="1", arg_eval=", Layout="),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout (Seconds)="),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Show Over Keyguard", arg_type="3", arg_eval=["e", ", Show Over Keyguard"]),
        ],
    ...
    "559t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Text", arg_type="1", arg_eval="Text="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Engine:Voice", arg_type="1", arg_eval=", Engine Voice="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Stream", arg_type="0", arg_eval=[", Stream=", "l", "171"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Pitch", arg_type="0", arg_eval=", Pitch="),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Speed", arg_type="0", arg_eval=", Speed="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Respect Audio Focus", arg_type="3", arg_eval=["e", ", Respect Audio Focus"]),
    ...
    "566t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Vibrate", arg_type="0", arg_eval=[", Vibrate=", "l", "566"]),
    ...
    "567t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=False, arg_name="In / For (Minutes)", arg_type="1", arg_eval="In/For Minutes="),
            ...
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Available", arg_type="3", arg_eval=["e", ", Available"]),
    ...
    "57t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Scene Name", arg_type="1", arg_eval="Scene Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Element", arg_type="1", arg_eval=", Element="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Orientation", arg_type="0", arg_eval=[", Orientation=", "l", "57"]),
            ...
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Animation Time (MS)", arg_type="0", arg_eval=", Animation Time (MS)="),
        ],
    ...
    "590t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Delete Base", arg_type="3", arg_eval=["e", ", Delete Base"]),
    ...
    "592t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Delete Parts", arg_type="3", arg_eval=["e", ", Delete Parts"]),
        ],
        name="Variable Join",
        category="120",
        canfail="False",
    ...
    "595t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Input Type", arg_type="0", arg_eval=[", Input Type=", "l", "595"]),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Default", arg_type="1", arg_eval=", Default="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Background Image", arg_type="1", arg_eval=", Background Image="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Layout", arg_type="1", arg_eval=", Layout="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout (Seconds)="),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="Show Over Keyguard", arg_type="3", arg_eval=["e", ", Show Over Keyguard"]),
        ],
        name="Variable Query",
        category="120",
        canfail="False",
    ...
    "596t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Name", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Function", arg_type="0", arg_eval=[", Function=", "l", "596"]),
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Store Result In", arg_type="1", arg_eval=", Store Result In="),
    ...
    "597t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Adapt To Fit", arg_type="3", arg_eval=["e", ", Adopt To Fit"]),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Store Result In", arg_type="1", arg_eval=", Store Result In="),
        ],
    ...
    "598t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Ignore Case", arg_type="3", arg_eval=["e", ", Ignore Case"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Multi-Line", arg_type="3", arg_eval=["e", ", Multi-Line"]),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="One Match Only", arg_type="3", arg_eval=["e", ", One Match Only"]),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Store Matches In Array", arg_type="1", arg_eval=", Show Matches In Array="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Replace Matches", arg_type="3", arg_eval=["e", ", Replace Matches"]),
            ArgumentCode(arg_id="7", arg_required=False, arg_name="Replace With", arg_type="1", arg_eval="Replace With"),
        ],
    ...
    "60t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Label", arg_type="1", arg_eval=", Label="),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Text Colour", arg_type="1", arg_eval=", Spot Radius (Meters)="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Text Size", arg_type="0", arg_eval=", Spot Color="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Spot Radius (Metres)", arg_type="0", arg_eval="Spot Radius (Metres)"),
    ...
    "612t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Scene Name", arg_type="1", arg_eval="Scene Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Element", arg_type="1", arg_eval=", Element="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Mode", arg_type="0", arg_eval=[", Mode=", "l", "612"]),
    ...
    "62t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Intensity Pattern", arg_type="1", arg_eval="Intensity Pattern"),
        ],
    ...
    "65t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Scene Name", arg_type="1", arg_eval="Scene Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Element Match", arg_type="1", arg_eval=", Element Match="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Set", arg_type="3", arg_eval=[", Set=", "l", "65"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Animation Time (MS)", arg_type="0", arg_eval="Animation Time (MS)="),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Continue Task Immediately", arg_type="3", arg_eval=["e", ", Continue Task Immediately"]),
        ],
    ...
    "664t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=False, arg_name="Class Or Object", arg_type="1", arg_eval=", Function="),
    ...
    "667t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Selection Parameters", arg_type="1", arg_eval="Selection Parameters"),
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Order By", arg_type="1", arg_eval="Order By"),
            ArgumentCode(arg_id="7", arg_required=False, arg_name="Output Column Divider", arg_type="1", arg_eval="Output Column Divider"),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="Variable Array", arg_type="1", arg_eval="Variable Array"),
            ArgumentCode(arg_id="9", arg_required=True, arg_name="Use Root", arg_type="3", arg_eval="Use Root"),
            ArgumentCode(arg_id="10", arg_required=True, arg_name="Use Global Namespace", arg_type="3", arg_eval="Use Global Namespace"),
        ],
        name="SQL Query",
        category="50",
        canfail="True",
    ...
    "699t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Continue Task Immediately", arg_type="3", arg_eval=["e", ", Continue Task Immediately"]),
        ],
        name="Say To File",
        category="10",
        canfail="True",
    ...
    "779t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=False, arg_name="Title", arg_type="1", arg_eval="Title="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Warn Not Exist", arg_type="3", arg_eval="Warn Not Exist"),
        ],
        name="Notify Cancel",
        category="10",
        canfail="False",
    ...
    "794t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Element", arg_type="1", arg_eval="Element="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Orientation", arg_type="0", arg_eval=[", Orientation=", "l", "57"]),
    ...
    "806t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Block Time (Check Help)", arg_type="0", arg_eval="Block Time="),
        ],
        name="Turn On",
        category="40",
        canfail="False",
    ...
    "810t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Level", arg_type="0", arg_eval="Level="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Disable Safeguard", arg_type="3", arg_eval=["e", ", Disable Safeguard"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Ignore Current Level", arg_type="3", arg_eval=["e", ", Ignore Current Level"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Immediate Effect", arg_type="3", arg_eval="Immediate Effect"),
        ],
    ...
    "877t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="9", arg_required=True, arg_name="Target", arg_type="0", arg_eval=[", Target=", "l", "877a"]),
        ],
        name="Send Intent",
        category="104",
        canfail="True",
    ...
    "888t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Name", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Value", arg_type="0", arg_eval=", Value="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Wrap Around", arg_type="0", arg_eval=", Wrap Around="),
        ],
        name="Variable Add",
        category="120",
        canfail="False",
    ...
    "902t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Source", arg_type="0", arg_eval=["Set=", "l", "901"]),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout (Seconds)="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Continue Task Immediately", arg_type="3", arg_eval=["e", ", Continue Task Immediately"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Keep Tracking", arg_type="3", arg_eval=["e", ", Keep Tracking"]),
        ],
        name="Get Location",
        category="60",
        canfail="True",
    ...
    "903t": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=False, arg_name="Title", arg_type="1", arg_eval="Title="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Language Model", arg_type="0", arg_eval=[", Mode=", "l", "903"]),
            ArgumentCode(arg_id="2", arg_required=False, arg_name="Language", arg_type="1", arg_eval=", Language="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Maximum Results", arg_type="0", arg_eval=", Maximum Results="),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="Hide Dialog", arg_type="3", arg_eval=["e", ", Hide Dialog"]),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="Output Variables", arg_type="5", arg_eval="Output Variables"),
        ],
        name="Get Voice",
        category="55",
    ...
    "907t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=False, arg_name="Icons To Hide", arg_type="1", arg_eval="Icons To Hide="),
        ],
    ...
    "90t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="Auto Dial", arg_type="3", arg_eval=["e", ", Auto Dial"]),
    ...
    "910t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="Action", arg_type="0", arg_eval=["Mode=", "l", "910"]),
        ],
        name="Call Log",
        category="90",
        canfail="False",
    ...
    "915t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Min. Frequency", arg_type="0", arg_eval="Min. Frequency"),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Max. Frequency", arg_type="0", arg_eval="Max. Frequency"),
        ],
        name="CPU",
        category="104",
        canfail="True",
    ...
    "941t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Timeout (Seconds)", arg_type="0", arg_eval=", Timeout (Seconds)"),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="Show Over Keyguard", arg_type="3", arg_eval=["e", ", Show Over Keyguard"]),
        ],
        name="HTML Popup",
        category="10",
        canfail="False",
    ...
    "95t": ActionCode(
        redirect="",
        args=[
            ArgumentCode(arg_id="0", arg_required=False, arg_name="Number Match", arg_type="1", arg_eval="Number Match="),
    ...
    "991t": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="2", arg_required=True, arg_name="Event ID", arg_type="1", arg_eval=", Event ID"),
            ArgumentCode(arg_id="3", arg_required=False, arg_name="Event Param Names", arg_type="1", arg_eval=", Event Param Names"),
            ArgumentCode(arg_id="4", arg_required=False, arg_name="Event Param Values", arg_type="1", arg_eval=", Event Param Values"),
            ArgumentCode(arg_id="5", arg_required=False, arg_name="Event Output Names", arg_type="1", arg_eval=", Event Output Names"),
            ArgumentCode(arg_id="6", arg_required=False, arg_name="Event Output Values", arg_type="1", arg_eval=", Event Output Values"),
        ],
    ...
    "ButtonElement": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="6", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Position=", "l", "TextElement1"]),
    ...
    "EditTextElement": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=True, arg_name="", arg_type="0", arg_eval=", Text Width Scale Percent="),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="", arg_type="1", arg_eval=", Text Color="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="", arg_type="1", arg_eval=", Font="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Position=", "l", "TextElement1"]),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Input Type=", "l", "EditTextElement"]),
    ...
    "ListElement": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Source=", "l", "ListElement1"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="", arg_type="1", arg_eval=[", Selection Mode=", "l", "ListElement2"]),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Selection Mode=", "l", "ListElement2"]),
    ...
    "MenuElement": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Source=", "l", "ListElement1"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Selection Mode=", "l", "ListElement2"]),
    ...
    "OvalElement": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Shader=", "l", "RectElement1"]),
    ...
    "PickerElement": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="5", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Format=", "l", "NumberPickerElement"]),
        ],
        name="",
        category="",
        canfail="",
    ...
    "RectElement": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="7", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Rounded Corners=", "l", "RectElement2"]),
        ],
        name="",
        category="",
        canfail="",
    ...
    "SceneElement": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="3", arg_required=True, arg_name="", arg_type="0", arg_eval=["", "e", ", Show Traffic"]),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="", arg_type="0", arg_eval=["", "e", ", Show Satellite"]),
    ...
    "SliderElement": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Orientation=", "l", "SliderElement1"]),
            ...
            ArgumentCode(arg_id="5", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Show Indicators=", "l", "SliderElement2"]),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="", arg_type="8", arg_eval=", Icon="),
        ],
        name="",
        category="",
    ...
    "SpinnerElement": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="4", arg_required=True, arg_name="", arg_type="None", arg_eval=", Popup Background Color="),
        ],
        name="",
        category="",
        canfail="",
    ...
    "TextElement": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="1", arg_required=True, arg_name="", arg_type="1", arg_eval=", Text="),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="", arg_type="0", arg_eval=", Text Size="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="", arg_type="0", arg_eval=", Text Width Scale Percent (100=0%)="),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="", arg_type="1", arg_eval=", Text Color="),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="", arg_type="1", arg_eval=", Font="),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Position=", "l", "TextElement1"]),
            ArgumentCode(arg_id="7", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Vertical Fit Mode=", "l", "TextElement2"]),
            ArgumentCode(arg_id="8", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Text Format=", "l", "TextElement3"]),
        ],
        name="",
        category="",
        canfail="",
    ...
    "ToggleElement": ActionCode(
        ...
        args=[
            ...
            ArgumentCode(arg_id="5", arg_required=True, arg_name="", arg_type="0", arg_eval=", Label Width Width Scale Percent (100=0%)="),
    ...
    "WebElement": ActionCode(
        ...
        args=[
            ArgumentCode(arg_id="0", arg_required=True, arg_name="", arg_type="1", arg_eval="Name="),
            ArgumentCode(arg_id="1", arg_required=True, arg_name="", arg_type="0", arg_eval=[", Mode=", "l", "WebElement"]),
            ArgumentCode(arg_id="2", arg_required=True, arg_name="", arg_type="1", arg_eval=", Source="),
            ArgumentCode(arg_id="3", arg_required=True, arg_name="", arg_type="0", arg_eval=["", "e", ", Allow Phone Access"]),
            ArgumentCode(arg_id="4", arg_required=True, arg_name="", arg_type="1", arg_eval=["", "e", ", Self Handle Links"]),
            ArgumentCode(arg_id="5", arg_required=True, arg_name="", arg_type="1", arg_eval=["", "e", ", DB API"]),
            ArgumentCode(arg_id="6", arg_required=True, arg_name="", arg_type="1", arg_eval=["", "e", ", Support Popups"]),
