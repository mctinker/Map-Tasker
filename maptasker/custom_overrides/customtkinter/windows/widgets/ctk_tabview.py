...
class CTkTabview(CTkBaseClass):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # shape
        self._corner_radius = (
            ThemeManager.theme["CTkFrame"]["corner_radius"] if corner_radius is None else corner_radius
        )
    ...
    def _configure_grid(self):
        ...
        if self._anchor.lower() in ("center", "w", "nw", "n", "ne", "e", "e"):
            self.grid_rowconfigure(
                0,
                weight=0,
                minsize=self._apply_widget_scaling(self._outer_spacing),
            )
            self.grid_rowconfigure(
                1,
                weight=0,
    ...
    def cget(self, attribute_name: str):
        ...
        if (
            attribute_name == "segmented_button_fg_color"
            or attribute_name == "segmented_button_selected_color"
            or attribute_name == "segmented_button_selected_hover_color"
            or attribute_name == "segmented_button_unselected_color"
            or attribute_name == "segmented_button_unselected_hover_color"
            or attribute_name == "text_color"
            or attribute_name == "text_color_disabled"
        ):
