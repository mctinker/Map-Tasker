...
lookup_values = {
    ...
    "PropertyElement2": ["System", "Landscape", "Portrait", "User", "Behind", "Sensor", "No Sensor", "Sensor Landscape", "Sensor Portrait", "Reverse Landscape", "Reverse Portrait", "Full Sensor"],
