...
dependencies = [
    "anthropic>=0.55.0",  #  Ai Anthropics support
    ...
    "openai>=1.91.0",  #  Ai OpenAi support
    "pillow==11.2.1",  # Image support in GUI.  Revert back to 11.2.0 to avoid UV bug with tkinter.
